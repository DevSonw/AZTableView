...
-(UIViewController *)basicRow{
    ...
    row3.detail = @"Value";
    row3.style = UITableViewCellStyleValue1;
    
    AZRow *row4 = [AZRow new];
    row4.text = @"Style value2";
    row4.detail = @"Value";
    row4.style = UITableViewCellStyleValue2;
    ...
    row6.style = UITableViewCellStyleSubtitle;
    ...
    row7.style = UITableViewCellStyleSubtitle;
    ...
    row8.text = @"Animate gif image from url";
    row8.detail = @"Gif image type";
    row8.style = UITableViewCellStyleSubtitle;
